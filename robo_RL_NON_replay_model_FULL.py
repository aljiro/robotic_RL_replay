	...
	def main(self):
		...
		while not rospy.core.is_shutdown():
			...
			if self.reward_val == 0:
				...
				# 	print(t_replay)
				# 	np.save('data/eligibility_trace_t_nonreplay=' + str(t_replay) + 's.npy', self.elig_trace)
...
if __name__ == '__main__':
	...
	for tau_elig in [parameters["figure4"]["non_replay"]["tau_elig"]]:
		for eta in [parameters["figure4"]["non_replay"]["eta"]]:
